...
public static void main(String args[]) throws Exception {
    ...
    checkPassword("srinivasan2","$S$DoSRhb2CuGosFvau8x2iQ3WsJLZmztYwZnQYLNGlKDs8aavIR9yl");
    checkPassword("admin123","$S$DIbd1mFX.5galdRdURWe/20ldjbSw1Mjaju/BCCVWsjn/aSqr.0q");
